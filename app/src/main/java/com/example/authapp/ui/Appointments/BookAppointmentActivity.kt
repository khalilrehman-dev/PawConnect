...
class BookAppointmentActivity :
    ...
    private lateinit var spinnerPet:
            Spinner

    private lateinit var tvDate:
            TextView

    private lateinit var tvTime:
            TextView
    ...
    override fun onCreate(
        ...
        setContentView(
            R.layout.activity_book_appointment
        )
    ...
    private fun submitAppointment() {
        ...
        if (selectedPet == null) {
            ...
            Toast.makeText(
                this,
                "Please add a pet before booking",
                Toast.LENGTH_SHORT
            ).show()
    ...
    private fun showTimePicker() {
        ...
        TimePickerDialog(
            ...
            { _, hour, minute ->
                ...
                /*
                 * Keep 24-hour values separately
                 * for scheduledAt.
                 */
                selectedHour =
                    hour
    ...
    private fun getSelectedScheduledAt():
            Long? {
    ...
    private fun showLoading(
        ...
        /*
         * Don't re-enable booking if
         * the user has no pets.
         */
        btnBook.isEnabled =
            !show &&
                    petList.isNotEmpty()
